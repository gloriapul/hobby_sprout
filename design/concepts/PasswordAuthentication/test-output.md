...
1. Creating a new user account with username and password
   ✓ User registered successfully with ID: 019a5b51-47bd-71a4-8b94-374e4cef4b53
2. Authenticating with the same username and password
   ✓ User authenticated successfully with the same ID: 019a5b51-47bd-71a4-8b94-374e4cef4b53
3. Principle satisfied: User can register and authenticate as the same identity
----- output end -----
Principle: User registers with unique credentials and authenticates as the same user ... ok (777ms)
...
----- output end -----
Action: register enforces username uniqueness ... ok (631ms)
...
----- output end -----
Action: authentication validates credentials and returns appropriate errors ... ok (665ms)
Action: deleteUser permanently removes user and prevents authentication ...
------- output -------
1. Creating a user to test deletion
   ✓ User registered with ID: 019a5b51-4f65-7c96-b1a2-9b9e16f0ea8d
...
5. Testing deletion of non-existent user
   ✓ Correctly failed with error: "User 019a5b51-4f65-7c96-b1a2-9b9e16f0ea8d not found."
6. Action requirements satisfied: deleteUser removes credentials permanently
----- output end -----
Action: deleteUser permanently removes user and prevents authentication ... ok (712ms)
